      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {[
              { value: '500+', label: 'Projects Completed', icon: <FiTool className="h-8 w-8 text-red-600" /> },
              { value: '50+', label: 'Industry Awards', icon: <FiAward className="h-8 w-8 text-red-600" /> },
              { value: '1000+', label: 'Satisfied Clients', icon: <FiUsers className="h-8 w-8 text-red-600" /> },
              { value: '12+', label: 'Years of Excellence', icon: <FaHardHat className="h-8 w-8 text-red-600" /> }
            ].map((stat, index) => (
              <motion.div
                key={index}
                variants={item}
